# AI Agent Guidelines for dev-portfolio

This guide provides essential information for AI agents working with the dev-portfolio codebase - a Next.js dev portfolio, blog, and component registry website.
