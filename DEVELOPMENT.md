...
```bash
git clone https://github.com/DevNagi31/dev-portfolio.git minimal-dev-portfolio
...
If you're working on a different React project and want to reuse the custom components from this repository, visit [devnagi.com/components](https://devnagi.com/components) for installation instructions and component documentation.
